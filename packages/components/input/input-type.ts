...
export type StarryTextareaResize = 'horizontal' | 'vertical' | 'both' | 'inline' | 'none';
...
export type StarryTextareaProps = JSX.HTMLElementTags['textarea'] & StarryTextareaOptions;
