...
import { StarryTagProps } from "./tag-type";

export function Tag(props: FlowProps<StarryTagProps>) {
    const { classes, otherProps, props: TagProps } = createComponentFactory({
        name: "tag",
        selfPropNames: ["colorType", "loading", "size", "disabled", 'bold', 'closable', 'maxWidth', 'round', 'left', 'right'],
        props: props,
        propDefaults: {
            size: "medium",
            colorType: "primary",
